...
import { buildPartialFulfilmentView } from "../../utils/partialFulfilment";
import {
...
// money.
function withOrderView<T extends { total: unknown; paymentStatus: unknown; deliveryAddress?: unknown }>(order: T) {
  return { ...order, ...buildOrderPaymentView(order), ...buildPartialFulfilmentView(order) };
}
...
export async function createSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 201, "Sales order created successfully", withOrderView(data));
}
...
export async function getSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Sales order fetched successfully", withOrderView(data));
}
...
export async function updateSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Sales order updated successfully", withOrderView(data));
}
...
export async function confirmSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Sales order confirmed successfully", withOrderView(data));
}
...
export async function rejectSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Sales order rejected successfully", withOrderView(data));
}
...
export async function cancelSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Sales order cancelled successfully", withOrderView(data));
}
...
export async function deliverSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Sales order delivered successfully", withOrderView(data));
}
...
export async function assignDriverToSalesOrderController(req: Request, res: Response) {
  ...
  return sendSuccess(res, 200, "Driver assigned successfully", withOrderView(data));
}

export async function proposePartialFulfilmentController(req: Request, res: Response) {
  await assertCanAccessOrder(req, req.auth!.activeOrganizationId!, req.params.id!);
  const data = await proposePartialFulfilment(
    req.auth!.activeOrganizationId!,
    req.params.id!,
    req.auth!.userId,
    req.body,
  );
  return sendSuccess(res, 200, "Revised order sent to the customer for approval", withOrderView(data));
}
