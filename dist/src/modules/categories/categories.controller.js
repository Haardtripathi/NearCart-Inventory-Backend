...
async function listCategoriesController(req, res) {
    ...
    const data = await (0, categories_service_1.listCategories)(req.auth.activeOrganizationId, req.query, localeContext);
...
async function getCategoryTreeController(req, res) {
    const localeContext = await (0, localization_1.resolveLocaleContext)(req);
    const data = await (0, categories_service_1.getCategoryTree)(req.auth.activeOrganizationId, localeContext);
    return (0, ApiResponse_1.sendSuccess)(res, 200, "Category tree fetched successfully", data);
}
async function createCategoryController(req, res) {
    const localeContext = await (0, localization_1.resolveLocaleContext)(req);
    const data = await (0, categories_service_1.createCategory)(req.auth.activeOrganizationId, req.auth.userId, req.body, localeContext);
...
async function getCategoryController(req, res) {
    const localeContext = await (0, localization_1.resolveLocaleContext)(req);
    const data = await (0, categories_service_1.getCategoryById)(req.auth.activeOrganizationId, req.params.id, localeContext);
    return (0, ApiResponse_1.sendSuccess)(res, 200, "Category fetched successfully", data);
}
async function updateCategoryController(req, res) {
    const localeContext = await (0, localization_1.resolveLocaleContext)(req);
    const data = await (0, categories_service_1.updateCategory)(req.auth.activeOrganizationId, req.params.id, req.auth.userId, req.body, localeContext);
