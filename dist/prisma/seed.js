...
function mergeSeedByKey(base, patch, getKey) {
...
function getSuggestedMasterCatalogName(code, fallback) {
    return nearcart_grocery_fmcg_seed_patch_1.suggestedMasterCatalogRenames.find((entry) => entry.code === code)?.suggestedName ?? fallback;
}
...
const industries = [
    {
        ...
        categories: [
            ...
            },
            {
                code: "snacks",
                sortOrder: 2,
                translations: withDescriptions(names("Snacks", "स्नैक्स", "નાસ્તા"), {
        ...
        items: [
            ...
            // Shelf brand belongs on Product; pack/SKU details belong on ProductVariant.
            {
                ...
                defaultTrackMethod: client_1.TrackMethod.PIECE,
            ...
            },
            {
                ...
                translations: withDescriptions(names("Glucose Biscuits", "ग्लूकोज़ बिस्किट", "ગ્લુકોઝ બિસ્કિટ"), {
                ...
                aliases: [
                    { language: client_1.LanguageCode.EN, value: "glucose biscuits" },
                    { language: client_1.LanguageCode.HI, value: "ग्लूकोज़ बिस्किट" },
                    { language: client_1.LanguageCode.GU, value: "ગ્લુકોઝ બિસ્કિટ" },
                ],
                defaultUnitCode: "pack",
            ...
            },
            {
                ...
                aliases: [
                    { language: client_1.LanguageCode.EN, value: "chai" },
                    { language: client_1.LanguageCode.EN, value: "tea pack" },
                ],
                defaultUnitCode: "pack",
            ...
            },
            {
                ...
                aliases: [{ language: client_1.LanguageCode.EN, value: "2 minute noodles" }],
                defaultUnitCode: "pack",
            ...
            },
            {
                ...
                aliases: [{ language: client_1.LanguageCode.EN, value: "arhar dal" }],
                defaultTrackMethod: client_1.TrackMethod.PIECE,
                defaultUnitCode: "pack",
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                aliases: [{ language: client_1.LanguageCode.EN, value: "oral rehydration salts" }],
                defaultUnitCode: "box",
...
const extraIndustries = [
    {
        ...
        translations: withDescriptions(names("Kitchenware", "रसोई सामान", "રસોઈ સામાન"), {
    ...
    },
    {
        ...
        translations: withDescriptions(names("Optical", "ऑप्टिकल", "ઓપ્ટિકલ"), {
    ...
    },
    {
        ...
        translations: withDescriptions(names("Florist", "फ्लोरिस्ट", "ફ્લોરિસ્ટ"), {
    ...
    },
    {
        ...
        translations: withDescriptions(names("Frozen Food", "फ्रोजन फूड", "ફ્રોઝન ફૂડ"), {
...
const groceryDemoBranches = [
    {
        code: "GROC-STORE-1",
        name: "NearCart Grocery Main Store",
        type: client_1.BranchType.STORE,
        phone: "+91-9900001101",
    ...
    },
    {
        ...
        type: client_1.BranchType.WAREHOUSE,
        phone: "+91-9900001102",
    ...
    },
    {
        ...
        type: client_1.BranchType.DARK_STORE,
        phone: "+91-9900001103",
...
const groceryDemoCategoriesBase = [
    {
        slug: "milk-dairy",
        sortOrder: 1,
        translations: {
...
const groceryDemoBrands = mergeSeedByKey(groceryDemoBrandsBase, nearcart_grocery_fmcg_seed_patch_1.groceryFmcgBrandPatch, (brand) => brand.slug);
const groceryDemoCategories = mergeSeedByKey(groceryDemoCategoriesBase, nearcart_grocery_fmcg_seed_patch_1.groceryFmcgCategoryPatch, (category) => category.slug);
...
function normalizeGroceryFmcgPatchProduct(product) {
    switch (product.slug) {
...
const groceryProductsBase = [
    {
        ...
        trackMethod: client_1.TrackMethod.PIECE,
...
const groceryProducts = mergeSeedByKey(groceryProductsBase, nearcart_grocery_fmcg_seed_patch_1.groceryFmcgProductPatch.map((product) => normalizeGroceryFmcgPatchProduct(product)), (product) => product.slug);
...
const groceryOrders = [
    {
        ...
        source: client_1.OrderSource.WHATSAPP,
    ...
    },
    {
        ...
        source: client_1.OrderSource.WALK_IN,
...
const pharmacyProducts = [
    ...
    },
    {
        ...
        primaryUnitCode: "ml",
        trackMethod: client_1.TrackMethod.VOLUME,
    ...
    },
    {
        ...
        primaryUnitCode: "pcs",
        trackMethod: client_1.TrackMethod.PIECE,
        productType: client_1.ProductType.SIMPLE,
        hasVariants: false,
...
const pharmacyOrders = [
    ...
    },
    {
        ...
        source: client_1.OrderSource.PHONE,
        status: client_1.SalesOrderStatus.CONFIRMED,
...
function bilingualTranslationRows(translations) {
    if ("EN" in translations && typeof translations.EN === "string") {
        const flat = translations;
        return [
            { language: client_1.LanguageCode.EN, name: flat.EN, description: null },
            { language: client_1.LanguageCode.HI, name: flat.HI, description: null },
        ];
    }
    const detailed = translations;
    return [
        { language: client_1.LanguageCode.EN, name: detailed.EN.name, description: detailed.EN.description ?? null },
        { language: client_1.LanguageCode.HI, name: detailed.HI.name, description: detailed.HI.description ?? null },
    ];
}
async function upsertUserSeed(params) {
    ...
    return prisma.user.upsert({
        ...
        update: {
            ...
            preferredLanguage: params.preferredLanguage ?? client_1.LanguageCode.EN,
            isActive: true,
...
async function ensureSeedSuperAdmin() {
    ...
    return prisma.user.upsert({
        ...
        update: {
            ...
            preferredLanguage: client_1.LanguageCode.EN,
            isActive: true,
            passwordSetupRequired: false,
            passwordChangedAt: new Date(),
        },
...
async function upsertOrganizationSeed(params) {
    return prisma.organization.upsert({
        ...
        update: {
            ...
            defaultLanguage: params.defaultLanguage ?? client_1.LanguageCode.EN,
...
async function upsertProductSeed(params) {
    ...
    const product = await prisma.product.upsert({
        ...
        update: {
            ...
            productType,
            sourceType: productSeed.sourceType ?? (masterItem ? client_1.ProductSourceType.MASTER_TEMPLATE : client_1.ProductSourceType.MANUAL),
            status: productSeed.status ?? client_1.ProductStatus.ACTIVE,
            hasVariants,
            ...
            trackMethod: productSeed.trackMethod ?? masterItem?.defaultTrackMethod ?? client_1.TrackMethod.PIECE,
    ...
    await prisma.productTranslation.createMany({
        data: [
            {
                productId: product.id,
                language: client_1.LanguageCode.EN,
                name: productSeed.name,
                description: productSeed.description ?? null,
            },
            {
                productId: product.id,
                language: client_1.LanguageCode.HI,
    ...
    for (const inventorySeed of params.inventory) {
        ...
        const existingLedger = await prisma.inventoryLedger.findFirst({
            where: {
                ...
                branchId,
                variantId: variantRef.variantId,
                referenceType: client_1.ReferenceType.MANUAL,
                referenceId,
            },
        });
        if (!existingLedger) {
            await prisma.inventoryLedger.create({
                data: {
                    ...
                    productId: variantRef.productId,
                    variantId: variantRef.variantId,
                    movementType: client_1.StockMovementType.OPENING,
                    referenceType: client_1.ReferenceType.MANUAL,
                    referenceId,
    ...
    for (const batchSeed of params.batches) {
        ...
        await prisma.inventoryBatch.upsert({
            ...
            update: {
                ...
                status: batchSeed.status ?? client_1.BatchStatus.ACTIVE,
    ...
    for (const receiptSeed of params.receipts) {
        ...
        const receipt = await prisma.purchaseReceipt.upsert({
            ...
            update: {
                branchId,
                supplierId,
                status: receiptSeed.status ?? client_1.PurchaseReceiptStatus.POSTED,
    ...
    for (const orderSeed of params.orders) {
        ...
        const order = await prisma.salesOrder.upsert({
            ...
            update: {
                ...
                status: orderSeed.status ?? client_1.SalesOrderStatus.PENDING,
                paymentStatus: orderSeed.paymentStatus ?? client_1.PaymentStatus.UNPAID,
    ...
    for (const transferSeed of params.transfers) {
        ...
        const transfer = await prisma.stockTransfer.upsert({
            ...
            update: {
                fromBranchId,
                toBranchId,
                status: transferSeed.status ?? client_1.StockTransferStatus.DRAFT,
...
async function seedDemoOrganizationCatalog(params) {
    ...
    const adminUser = await upsertUserSeed({
        ...
        platformRole: client_1.UserRole.ORG_ADMIN,
    });
    ...
    const staffUser = await upsertUserSeed({
        ...
        preferredLanguage: client_1.LanguageCode.HI,
    });
