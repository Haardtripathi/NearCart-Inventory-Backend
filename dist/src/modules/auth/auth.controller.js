...
async function loginController(req, res) {
    ...
    const data = await (0, auth_service_1.login)(req.body, (0, request_1.getRequestMeta)(req), localeContext);
...
async function completeAccountSetupController(req, res) {
    const localeContext = await (0, localization_1.resolveLocaleContext)(req);
    const data = await (0, auth_service_1.completeAccountSetup)(req.body, (0, request_1.getRequestMeta)(req), localeContext);
    return (0, ApiResponse_1.sendSuccess)(res, 200, "Account setup completed successfully", data);
}
async function resetPasswordController(req, res) {
    const localeContext = await (0, localization_1.resolveLocaleContext)(req);
    const data = await (0, auth_service_1.resetPasswordWithToken)(req.body, (0, request_1.getRequestMeta)(req), localeContext);
...
async function meController(req, res) {
    ...
    const data = await (0, auth_service_1.getMe)(req.auth.userId, requestedOrganizationId, req.auth.role, localeContext);
