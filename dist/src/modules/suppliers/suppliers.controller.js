...
async function listSuppliersController(req, res) {
    const data = await (0, suppliers_service_1.listSuppliers)(req.auth.activeOrganizationId, req.query);
...
async function createSupplierController(req, res) {
    const data = await (0, suppliers_service_1.createSupplier)(req.auth.activeOrganizationId, req.auth.userId, req.body);
...
async function getSupplierController(req, res) {
    const data = await (0, suppliers_service_1.getSupplierById)(req.auth.activeOrganizationId, req.params.id);
...
async function updateSupplierController(req, res) {
    const data = await (0, suppliers_service_1.updateSupplier)(req.auth.activeOrganizationId, req.params.id, req.auth.userId, req.body);
