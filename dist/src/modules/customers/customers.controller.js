...
async function listCustomersController(req, res) {
    const data = await (0, customers_service_1.listCustomers)(req.auth.activeOrganizationId, req.query);
...
async function createCustomerController(req, res) {
    const data = await (0, customers_service_1.createCustomer)(req.auth.activeOrganizationId, req.auth.userId, req.body);
...
async function getCustomerController(req, res) {
    const data = await (0, customers_service_1.getCustomerById)(req.auth.activeOrganizationId, req.params.id);
...
async function updateCustomerController(req, res) {
    const data = await (0, customers_service_1.updateCustomer)(req.auth.activeOrganizationId, req.params.id, req.auth.userId, req.body);
