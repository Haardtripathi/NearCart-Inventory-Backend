...
import { createBrand, deleteBrand, listBrands, updateBrand } from "./brands.service";

export async function listBrandsController(req: Request, res: Response) {
  const data = await listBrands(req.auth!.activeOrganizationId!, req.query as never);
...
export async function createBrandController(req: Request, res: Response) {
  const data = await createBrand(req.auth!.activeOrganizationId!, req.auth!.userId, req.body);
...
export async function updateBrandController(req: Request, res: Response) {
  const data = await updateBrand(req.auth!.activeOrganizationId!, req.params.id!, req.auth!.userId, req.body);
