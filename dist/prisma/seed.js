...
const industries = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                translations: withDescriptions(names("Parle-G Gluco Biscuits", "पारले-जी ग्लूको बिस्किट", "પાર્લે-જી ગ્લુકો બિસ્કિટ"), {
                ...
                aliases: [
                    { language: client_1.LanguageCode.EN, value: "Parle-G" },
                    { language: client_1.LanguageCode.EN, value: "glucose biscuits" },
                    { language: client_1.LanguageCode.HI, value: "पारले जी" },
                    { language: client_1.LanguageCode.GU, value: "પાર્લે જી" },
                ],
                defaultUnitCode: "pack",
            ...
            },
            {
                ...
                aliases: [{ language: client_1.LanguageCode.EN, value: "chai" }],
                defaultUnitCode: "pack",
...
const groceryProducts = [
    ...
    },
    {
        ...
        primaryUnitCode: "kg",
        trackMethod: client_1.TrackMethod.WEIGHT,
